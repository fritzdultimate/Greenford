...
<div class="section mt-4">
            ...
            <div class="transactions">
                ...
                <a href="app-transaction-detail.html" class="item">
                    <div class="detail">
                        <img src="{{ asset('app/img/sample/brand/1.jpg') }}" alt="img" class="image-block imaged w48">
                        <div>
                ...
                <a href="app-transaction-detail.html" class="item">
                    <div class="detail">
                        <img src="{{ asset('app/img/sample/avatar/avatar3.jpg') }}" alt="img" class="image-block imaged w48">
                        <div>
                ...
                <a href="app-transaction-detail.html" class="item">
                    <div class="detail">
                        <img src="{{ asset('app/img/sample/avatar/avatar4.jpg') }}" alt="img" class="image-block imaged w48">
                        <div>
