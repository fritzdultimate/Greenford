            ...
            <div class="wallet-card">
                ...
                <div class="balance">
                    <div class="left">
                        ...
                        <h1 class="total">{{ get_currency_symbol($user_settings->currency) }} {{ currency_conversion($user_settings->currency, number_format($total_locked_fund + $total_savings + $user_account->account_balance, 2, '.', ',')) }}</h1>
                    </div>
                    <div class="right">
